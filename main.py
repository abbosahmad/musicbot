...
async def post_music(track_info: Dict):
    ...
    async with PROCESSING_LOCK:
        ...
        try:
            ...
            if not dirty_file:
                raise Exception("Telegramdan yuklab bo'lmadi.")
            ...
            # Avtomatik ravishda bot username'ini olish
            bot_info = await bot.get_me()
            bot_username = bot_info.username or "MusiqaBot"
...
async def on_startup(bot: Bot):
    # --- Server tozalash jarayoni (Memory leak himoyasi) ---
    logger.info("♻️ Server tozalanmoqda: eski 'downloads' fayllari o'chirilmoqda...")
